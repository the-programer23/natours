...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(firstName, lastName, email, travelAgencyName, password, confirmPassword) {
    var res, _firstName;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              location.assign("/activeTours/?alert=signup&name=".concat(_firstName, "&email=").concat(email)); // const firstName = name.split(' ')[0]
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Acceso concedido, bienvenido");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'No pude cerrar tu sesión, por favor intenta de nuevo');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmFiaWFucGluMSIsImEiOiJjazhidndhMHQwZGFsM2tvMWNvbzIxZzV1In0.HOTBdecbpmDsp0zuzC9QwA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/fabianpin1/ck8bwf1no0y851jpdlgtz2v76' // center: [-118.292382, 34.054915],
    // zoom: 6
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>D\xEDa ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend map bounds to include current location
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'contraseña' ? '/api/v1/users/updateMyPassword' : '/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success' && type === 'contraseña') {
              (0, _alert.showAlert)('success', 'Su contraseña se actualizó correctamente');
            } else if (res.data.status === 'success' && type === 'datos') {
              (0, _alert.showAlert)('success', 'Sus datos se actualizaron exitosamente');
            }
...
var stripe = Stripe('pk_test_gZhydk3m6oRAQs96CqN0TDQn00GUx6FpT3');
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"createTour.js":[function(require,module,exports) {
"use strict";
...
var createTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, duration, maxGroupSize, difficulty, price, summary, description) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Felicidades, agregaste tu primer tour');
            }
  ...
  return function createTour(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref.apply(this, arguments);
  };
}();
...
if (createTourForm) {
  createTourForm.addEventListener('submit', function (e) {
    ...
    var description = document.getElementById('description').value; // form.append('imageCover', document.getElementById('imageCover').files[0])

    (0, _createTour.createTour)(name, duration, maxGroupSize, difficulty, price, summary, description);
  });
}
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var travelAgencyName = document.getElementById('travelAgencyName').value;
    var password = document.getElementById('password').value;
    var confirmPassword = document.getElementById('confirmPassword').value;
    (0, _signup.signup)(firstName, lastName, email, travelAgencyName, password, confirmPassword);
  });
}
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    form.append('photo', document.getElementById('photo').files[0]); // this passes firstName, lastName, email the the rest of the fields values to axios and it put them in req.body for example req.body.name ...

    (0, _updateSettings.updateSettings)(form, 'datos');
  });
}
...
if (alertMessage) (0, _alert.showAlert)('success', alertMessage, 2000);
},{"./alert":"alert.js","./signup":"signup.js","./login":"login.js","./mapbox":"mapbox.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js","./createTour":"createTour.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
